...
def text_frame_configure(present_section,present_note_section):
        ...
        if purpose in list_file_existance_option:
            ...
            if file_accessible != None:
                if file_accessible == False:
                    with open(note_directory, 'w') as f:
                        f.write("")
                    f.close()
                else:
                    pass
    ...
    if present_section != "":
        if present_note_section != "":
            ...
            note_directory_present = dict_note[previous_note_section] + "/" + present_section + " " + present_note_section + ".txt"
...
def maindisplay():
    ...
    def section_note_formation(section_or_note, text_name, present_name,section_name=None):
        ...
        if section_or_note == "section":
            ...
            [present("add", list_maindisplay_widgets, "note", present_name),text_frame_configure(section_name,present_name)])
